...
const Sidebar = () => {
  ...
  return (
    <div className="w-0 md:w-auto z-50 relative min-h-0 md:min-h-screen md:flex" data-dev-hint="container">
      ...
      <aside
        id="sidebar"
        className={`${menuOpen ? 'translate-x-0' : '-translate-x-full'} z-2 bg-black min-w-[250px] md:pt-0 pt-10 text-gray-100 absolute inset-y-0 left-0 transform md:relative md:translate-x-0 transition duration-200 ease-in-out  md:flex md:flex-col md:justify-between overflow-y-auto`}
      >
          ...
          <nav data-dev-hint="main navigation">
            <div className="h-screen p-5 overflow-y-scroll text-xs text-gray-500 pb-36">
              <div className="space-y-4">
                <Link href="/search" >
                  <a className="flex items-center space-x-2 hover:text-white" onClick={() => setMenuOpen(false)}>
