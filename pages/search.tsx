    ...
    <div className="w-full h-screen text-white">
      <div className="p-5">
        <div className="relative z-1">
          <div className="absolute z-1 inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
            <svg
          ...
          <input
            type="search"
            id="default-search"
            className="w-full p-3 pl-10 text-sm text-gray-900 border border-gray-300 border-none rounded-full sm:w-96 bg-gray-50 focus:ring-0 focus:outline-none placeholder:text-gray-500"
